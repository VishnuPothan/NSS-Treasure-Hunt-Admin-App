...
public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fadeAnimation = AnimationUtils.loadAnimation(com.codemaster.nsstreasurehuntadmin.SplashScreen.this, R.anim.fade);
        ...
        new Handler().postDelayed(() -> {
            if (SharedPreference.getUserVerified(getApplicationContext())){
                ...
                Intent verifyIntent = new Intent(com.codemaster.nsstreasurehuntadmin.SplashScreen.this, LoginActivity.class);
